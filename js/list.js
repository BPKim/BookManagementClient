	...
	$.ajax({
		...
		success : function(data){
			...
			for(var i = 0 ; i < data.length ; i++) {
				...
				var updateBtn =$("<input class='btn btn-sm btn-warning'>");
				updateBtn.attr("type", "button")
				updateBtn.attr("value","수정");
				updateBtn.attr("id", "updateBtn");


				var saveBtn =$("<input class='btn btn-sm btn-danger'>");
...
$(document).on('click', '#comseeBtn', function () {
	...
	// var comDiv = $("<div ></div>")
	var comTa = $("<table class='table usertable-striped'></table>");
